...
import { ArrowLeft, Filter, Plus, Trash2, Download, Edit, Receipt, Upload } from 'lucide-react';
import { getExpenses, deleteExpense, Expense } from '../lib/localStorage';
                ...
                <tbody>
                  {filteredExpenses.map(expense => (
                    ...
                    >
                      ...
                      <td className="py-4">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${expense.type === 'manual'
